...
namespace DesignAutomationHandler
{
    ...
    class DesignAutomationCommand : IDesignAutomationCommand
    {
        public override void DoJob()
        {
            Autodesk.Revit.ApplicationServices.Application app = CommandData.Application.Application;
            Doc = Doc ?? CommandData.Application.ActiveUIDocument?.Document;
            HandleDAApplication(app, Doc);
        }
        /// <summary>
        /// make sure design automation loaded
        /// </summary>
        /// <param name="app"></param>
        public void EnsureDesignAutomation(Autodesk.Revit.ApplicationServices.Application app)
        {
                ...
                foreach (XElement e in childList)
                {
                    try
                    {
                        ...
                        if (designAutomationBridge && revitAPIUI)
                            MessageBox.Show($"RevitAPIUI detected in DA Plugin: {e.Element("Assembly").Value}",
